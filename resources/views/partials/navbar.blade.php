            ...
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                @if( !empty(Auth::user()->profile_img) )
                  <img src="{{ asset('storage/upload/user_image/'.Auth::user()->profile_img) }}" alt class="w-px-40 h-auto rounded-circle">
                @else
                  <img src="{{ asset('storage/upload/dummy.png') }}" alt class="w-px-40 h-auto rounded-circle">
                @endif
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="pages-account-settings-account.html">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <small class="text-muted fw-semibold">{{strtoupper(Auth::user()->roles[0]->name)}}</small>
                    </div>
                  </div>
                </a>
              </li>
